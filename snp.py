...
from sho import make, algo, iters, plot, num, bit, pb, proba, temp, variation
...
if __name__ == "__main__":
    ...
    solvers = ["num_greedy", "bit_greedy",
               "bit_simulated_annealing", "num_simulated_annealing", "num_population_based", "bit_population_based"]
    ...
    temperatures = ["proportional", "square", "logarithmic"]
    ...
    can.add_argument("-p", "--population", metavar="POP", default=100, type=int,
    ...
    if the.solver == "num_greedy":
        ...
        val, sol = algo.population_based(
            ...
            make.init(num.rand,
                      ...
                      scale=the.domain_width),
            iters,
            make.variation(variation.variate),
            20
        )
        sensors = num.to_sensors(sol)

    elif the.solver == "bit_population_based":
        val, sol = algo.population_based(
            make.func(bit.cover_sum,
                      domain_width=the.domain_width,
                      sensor_range=the.sensor_range,
